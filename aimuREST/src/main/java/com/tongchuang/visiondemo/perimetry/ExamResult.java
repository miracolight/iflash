...
public class ExamResult {
    ...
    private Map<String, String> examCurLeft;   // added by Ming 12/29/2016 for aggression analysis

    private Map<String, String> examResultRight;
    private Map<String, String> allResponsesRight;
    private Map<String, String> examCurRight; // added by Ming 12/29/2016 for aggression analysis
	...
	public Map<String, String> getExamCurLeft() {                       // added by Ming 12/29/2016
		return examCurLeft;
	}
	public void setExamCurLeft(Map<String, String> examCurLeft) {
		this.examCurLeft = examCurLeft;                            
	}                                                                   // added by Ming 12/29/2016
	...
	public Map<String, String> getExamCurRight() {                   // added by Ming 12/29/2016
		return examCurRight;
	}
	public void setExamCurRight(Map<String, String> examCurRight) {
		this.examCurRight = examCurRight;
	}                                                                 // added by Ming 12/29/2016
