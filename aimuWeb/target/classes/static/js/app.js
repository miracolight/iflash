...
require.config({
    paths:{
       ...
       // "ngBootstrap" : 'http://bootzee.com/js/ui-bootstrap-tpls-0.11.2',
        ...
        "testReportCurCtrl":"/js/controllers/testReportCurCtrl" 	
    },
    shim:{
        "angular": {
            exports: "angular"
...
require(["angular", "angular-route", "angular-cookies","ngBootstrap","Pagination",
    "AllFilter",
    "Http","API",
    "indexCtrl", "adminCtrl", "patientCtrl", "loginCtrl","testReportCtrl", "testReportCurCtrl"],
...
app.controller("testReportCurCtrl",testReportCurCtrl)
